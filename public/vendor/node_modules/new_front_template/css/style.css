...
.banner{
	min-height: 795px;
	background:url(../images/maxresdefault.jpg)no-repeat center 0px;
...
/*-- section --*/
.agileits-section{
	background:url(../images/eye-cat.jpg) center no-repeat;
	background-size:cover;
	min-height:335px;
}
.agileits-section p {
...
.agile-about-right {
    background: url(https://livedemo00.template-help.com/wt_prod-2269/images/testimonials-01-960x700.jpg) no-repeat center;
    background-size: cover;
    min-height: 428px;
}
...
.client-img.c2{
	background:url(../images/customer2.jpg) no-repeat center;
	background-size:cover;
}
.client-img.c3{
	background:url(../images/customer3.jpg) no-repeat center;
	background-size:cover;
}
.client-img  img{
	width:100%;
...
.wthree-contact:before {
    content: '';
    background: url(../images/dogandcat.png)no-repeat 0px 0px;
    background-size: 100%;
    display: block;
    position: absolute;
    top: -16.5%;
