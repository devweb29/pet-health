    ...
    <script>
        $(function(){
            ...
            $('body').delegate('.btn-approved','click',function(){
                ...
                var params_unavailable = {
                    appointment_key: key,
                    date: date,
                    time: time,
                };

                setUnavailableFirebase(params_unavailable);
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            //REMOVE TO UNAVAILABLE
                            removeUnavailableFirebase(key);
